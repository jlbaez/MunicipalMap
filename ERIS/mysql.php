...
function authenticate($user, $pass){
	...
	mysql_connect("10.1.0.237:3306", "root", "my59Ld8", "mapping_accounts") or die(mysql_error());
	mysql_select_db("mapping_accounts") or die(mysql_error());
