										...
										<form id="search_property">
											...
											<ul class="filters">
												<li class="property_li">
													...
													<ul class=" dropdown filters animate hidden">
														<li class="li_filter">
							...
							<li>
								...
								<ul id="dropdown3" class="dropdown main animate hidden">
									<li class="buffer">
										...
										<input type="text" id="buffer_distance" value="200">
									</li>
									<li class="buffer">
										...
										<ul class="about_ul animate hidden">
											<li>
												<p>
													...
													<a href="http://meri.njmeadowlands.gov/help/eris-version-3/" class="about_link" target="_blank">here</a>.
												</p>
											</li>
										</ul>
									</li>
